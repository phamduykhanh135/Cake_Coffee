...
// import 'package:cake_coffee/models/khanh/demo.dart';
...
//   TextEditingValue _formatCurrency(String value) {
//     if (value.isEmpty) {
...
//     NumberFormat formatter = NumberFormat.currency(locale: 'vi_VN', symbol: '');
...
//     return WillPopScope(
//       onWillPop: () async {
//         return !_isLoading; // Prevent back navigation if loading
//       },
//       child: Scaffold(
//         body: Padding(
