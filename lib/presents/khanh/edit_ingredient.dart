...
class _EditIngredientPageState extends State<EditIngredientPage> {
  ...
  void initState() {
    ...
    _numberController =
        TextEditingController(text: widget.ingredient.number.toString());
  ...
  void _editIngredient(String ingredientId) async {
    ...
    int number = int.tryParse(_numberController.text.trim()) ?? 0;
    ...
    try {
      ...
      setState(() {
        ...
        widget.ingredient.price = price;
        widget.ingredient.number = number;
