...
//   final String nvName;
//   const In_Place({super.key, required this.nvName});
...
//                       // List<Tables> add_ = tables
//                       //     .where((table) => table.status == 'Ngồi chung')
//                       //     .toList();
...
//     List<List<Tables>> groupedTables = _groupTablesByStatus2(tables);
...
//             padding: const EdgeInsets.all(15),
//             child: Column(
//               children: groupedTables.map((group) {
//                 bool isNeighborSameStatus2 = group.length > 1;

//                 return Container(
//                   margin: const EdgeInsets.symmetric(vertical: 5),
//                   decoration: BoxDecoration(
//                     border: isNeighborSameStatus2
